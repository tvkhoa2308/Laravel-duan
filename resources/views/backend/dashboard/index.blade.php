...
<!-- Mirrored from themesbrand.com/velzon/html/corporate/dashboard-nft.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Mar 2025 16:19:39 GMT -->
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="themeadmin/velzon/assets/images/favicon.ico">

    <!--Swiper slider css-->
    <link href="themeadmin/velzon/assets/libs/swiper/swiper-bundle.min.css" rel="stylesheet" type="text/css" />

    <!-- jsvectormap css -->
    <link href="themeadmin/velzon/assets/libs/jsvectormap/jsvectormap.min.css" rel="stylesheet" type="text/css" />

    <!-- Layout config Js -->
    <script src="themeadmin/velzon/assets/js/layout.js"></script>
    <!-- Bootstrap Css -->
    <link href="themeadmin/velzon/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    <link href="themeadmin/velzon/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
    <!-- App Css-->
    <link href="themeadmin/velzon/assets/css/app.min.css" rel="stylesheet" type="text/css" />
    <!-- custom Css-->
    <link href="themeadmin/velzon/assets/css/custom.min.css" rel="stylesheet" type="text/css" />
...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="col-xl-6">
                                    <div class="card overflow-hidden">
                                        <div class="card-body bg-marketplace d-flex">
                                            ...
                                            <img src="themeadmin/velzon/assets/images/bg-d.png" alt="" class="img-fluid" />
                                        </div>
                                    </div>
                                </div><!--end col-->
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-xxl-4">
                                                    <div class="border-start p-4 h-100 d-flex flex-column">
                                                        ...
                                                        <div class="w-100">
                                                            <div class="d-flex align-items-center">
                                                                <img src="../../../../img.themesbrand.com/velzon/images/img-2.gif" class="img-fluid avatar-xs rounded-circle object-fit-cover" alt="">
                                        ...
                                        <div data-simplebar style="max-height: 350px;">
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="themeadmin/velzon/assets/images/users/avatar-10.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!" class="stretched-link">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="themeadmin/velzon/assets/images/nft/img-01.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="themeadmin/velzon/assets/images/nft/img-04.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="themeadmin/velzon/assets/images/nft/img-06.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="themeadmin/velzon/assets/images/users/avatar-8.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="themeadmin/velzon/assets/images/nft/img-03.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                ...
                                                <li class="list-group-item list-group-item-action">
                                                    <div class="d-flex align-items-center">
                                                        <img src="themeadmin/velzon/assets/images/nft/img-05.jpg" alt="" class="avatar-xs object-fit-cover rounded-circle">
                                                        <div class="ms-3 flex-grow-1">
                                                            <a href="#!">
                                                                <h6 class="fs-14 mb-1">Timothy Smith</h6>
                                                            </a>
                            ...
                            <div class="swiper marketplace-swiper rounded gallery-light">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details.html" class="text-body">Walking On Air</a></h5>
                                                <p class="text-muted mb-0">Artwork</p>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            <div class="explore-place-bid-img">
                                                <img src="themeadmin/velzon/assets/images/nft/img-03.jpg" alt="" class="img-fluid card-img-top explore-img" />
                                                <div class="bg-overlay"></div>
                                                <div class="place-bid-btn">
                                                    <a href="#!" class="btn btn-secondary"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details.html" class="text-body">Filtered Portrait</a></h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details.html" class="text-body">Patterns Arts & Culture</a></h5>
                                                <p class="text-muted mb-0">Artwork</p>
                                            </div>
                                            <div class="card-footer border-top border-top-dashed">
                                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1 fs-16"><a href="apps-nft-item-details.html" class="text-body">Evolved Reality</a></h5>
                                            ...
                                            <table class="table table-borderless align-middle">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="themeadmin/velzon/assets/images/nft/img-01.jpg" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="themeadmin/velzon/assets/images/nft/img-02.jpg" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="themeadmin/velzon/assets/images/nft/img-03.jpg" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="themeadmin/velzon/assets/images/nft/img-04.jpg" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="themeadmin/velzon/assets/images/nft/img-05.jpg" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="themeadmin/velzon/assets/images/nft/img-06.jpg" alt="" class="avatar-sm rounded-circle">
                                                                <div class="ms-3">
                                                                    <a href="#!">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="themeadmin/velzon/assets/images/nft/img-01.jpg" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="apps-nft-item-details.html" class="text-body">Abstract Face Painting</a></h6>
                                                                <p class="text-muted fs-13 mb-0"> Artworks</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><img src="themeadmin/velzon/assets/images/svg/crypto-icons/btc.svg" class="avatar-xxs me-2" alt="">48,568.025</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="apps-nft-item-details.html" class="text-body">Long-tailed Macaque</a></h6>
                                                                <p class="text-muted fs-13 mb-0">Games</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><img src="themeadmin/velzon/assets/images/svg/crypto-icons/ltc.svg" class="avatar-xxs me-2" alt="">87,142.027</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="themeadmin/velzon/assets/images/nft/img-06.jpg" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="apps-nft-item-details.html" class="text-body">Robotic Body Art</a></h6>
                                                                <p class="text-muted fs-13 mb-0">Photography</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><img src="themeadmin/velzon/assets/images/svg/crypto-icons/etc.svg" class="avatar-xxs me-2" alt="">33,847.961</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="themeadmin/velzon/assets/images/nft/img-04.jpg" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="apps-nft-item-details.html" class="text-body">Smillevers Crypto</a></h6>
                                                                <p class="text-muted fs-13 mb-0">Artworks</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><img src="themeadmin/velzon/assets/images/svg/crypto-icons/dash.svg" class="avatar-xxs me-2" alt="">73,654.421</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="themeadmin/velzon/assets/images/nft/img-03.jpg" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="apps-nft-item-details.html" class="text-body">Creative Filtered Portrait</a></h6>
                                                                <p class="text-muted fs-13 mb-0"> 3d Style</p>
                                                            </div>
                                                            <div class="flex-grow-1"></div>
                                                        </div>
                                                    </td>
                                                    <td><img src="themeadmin/velzon/assets/images/svg/crypto-icons/bnb.svg" class="avatar-xxs me-2" alt="">66,742.077</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="themeadmin/velzon/assets/images/nft/img-02.jpg" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h6 class="mb-1"><a href="apps-nft-item-details.html" class="text-body">The Chirstoper</a></h6>
                                                                <p class="text-muted fs-13 mb-0"> Crypto Card</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><img src="themeadmin/velzon/assets/images/svg/crypto-icons/usdt.svg" class="avatar-xxs me-2" alt="">34,736.209</td>
                                                    <td>
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-1">
                                        <p class="mb-1"><img src="themeadmin/velzon/assets/images/flags/us.svg" alt="" height="15" class="rounded me-2"> United States <span class="float-end">34%</span></p>
                                        <p class="mb-1"><img src="themeadmin/velzon/assets/images/flags/russia.svg" alt="" height="15" class="rounded me-2"> Russia <span class="float-end">27%</span></p>
                                        <p class="mb-1"><img src="themeadmin/velzon/assets/images/flags/spain.svg" alt="" height="15" class="rounded me-2"> Spain <span class="float-end">21%</span></p>
                                        <p class="mb-1"><img src="themeadmin/velzon/assets/images/flags/italy.svg" alt="" height="15" class="rounded me-2"> Italy <span class="float-end">13%</span></p>
                                        <p class="mb-0"><img src="themeadmin/velzon/assets/images/flags/germany.svg" alt="" height="15" class="rounded me-2"> Germany <span class="float-end">5%</span></p>
                                    </div>
                                </div>
                                <!-- end card body -->
                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="themeadmin/velzon/assets/images/nft/img-03.jpg" alt="" height="220" class="object-fit-cover w-100" />
                                            ...
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="themeadmin/velzon/assets/images/nft/img-04.jpg" alt="" height="220" class="object-fit-cover w-100" />
                                                    <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <a href="#!">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="../../../../img.themesbrand.com/velzon/images/img-5.gif" alt="" height="220" class="object-fit-cover w-100" />
                                                    <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <a href="#!">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="themeadmin/velzon/assets/images/nft/img-06.jpg" alt="" height="220" class="object-fit-cover w-100" />
                                                    <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <a href="#!">
                                    ...
                                    <div class="swiper collection-slider">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="d-flex">
                                                    <div class="flex-shink-0">
                                                        <img src="themeadmin/velzon/assets/images/nft/img-02.jpg" alt="" class="avatar-sm object-fit-cover rounded">
                                                    </div>
                                                    <div class="ms-3 flex-grow-1">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex">
                                                    <div class="flex-shink-0">
                                                        <img src="themeadmin/velzon/assets/images/nft/img-01.jpg" alt="" class="avatar-sm object-fit-cover rounded">
                                                    </div>
                                                    <div class="ms-3 flex-grow-1">
                                                        <a href="pages-profile.html">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex">
                                                    <div class="flex-shink-0">
                                                        <img src="themeadmin/velzon/assets/images/nft/img-04.jpg" alt="" class="avatar-sm object-fit-cover rounded">
                                                    </div>
                                                    <div class="ms-3 flex-grow-1">
                                                        <a href="pages-profile.html">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex">
                                                    <div class="flex-shink-0">
                                                        <img src="themeadmin/velzon/assets/images/users/avatar-1.jpg" alt="" class="avatar-sm object-fit-cover rounded">
                                                    </div>
                                                    <div class="ms-3 flex-grow-1">
                                                        <a href="pages-profile.html">
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                    <img src="themeadmin/velzon/assets/images/sidebar/img-1.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                    <img src="themeadmin/velzon/assets/images/sidebar/img-2.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-03" value="img-3">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                    <img src="themeadmin/velzon/assets/images/sidebar/img-3.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-04" value="img-4">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                    <img src="themeadmin/velzon/assets/images/sidebar/img-4.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    <!--Swiper slider js-->
    <script src="themeadmin/velzon/assets/libs/swiper/swiper-bundle.min.js"></script>

    <!-- Vector map-->
    <script src="themeadmin/velzon/assets/libs/jsvectormap/jsvectormap.min.js"></script>
    <script src="themeadmin/velzon/assets/libs/jsvectormap/maps/world-merc.js"></script>

    <!-- Countdown js -->
    <script src="themeadmin/velzon/assets/js/pages/coming-soon.init.js"></script>

    <!-- Marketplace init -->
    <script src="themeadmin/velzon/assets/js/pages/dashboard-nft.init.js"></script>
...
<!-- Mirrored from themesbrand.com/velzon/html/corporate/dashboard-nft.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Mar 2025 16:19:44 GMT -->
</html>
