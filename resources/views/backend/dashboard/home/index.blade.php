        ...
        <div class="row dash-nft">
                    ...
                    <div class="col-xl-6">
                        <div class="card overflow-hidden">
                            <div class="card-body bg-marketplace d-flex">
                                ...
                                <img src="themeadmin/velzon/assets/images/bg-d.png" alt=""
                                    class="img-fluid" />
                            </div>
                        </div>
                    </div><!--end col-->
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-xxl-4">
                                        <div class="border-start p-4 h-100 d-flex flex-column">
                                            ...
                                            <div class="w-100">
                                                <div class="d-flex align-items-center">
                                                    <img src="../../../../img.themesbrand.com/velzon/images/img-2.gif"
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <h4 class="fs-18 ff-secondary fw-semibold mb-0">342.74
                                                            ETH</h4>
                                                    </div>

                                                    <div>
                                                        <p class="fs-14 text-muted mb-1">Highest Bid</p>
                                                        <h4 class="fs-18 ff-secondary fw-semibold mb-0">346.67
                                                            ETH</h4>
                                                    </div>
                                                </div>
            ...
            <div class="col-xxl-3">
                <div class="card">
                    ...
                    <div>
                        <div id="market-overview" data-colors='["--vz-success", "--vz-secondary"]'
                            ...
                            <div data-simplebar style="max-height: 350px;">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item list-group-item-action">
                                        <div class="d-flex align-items-center">
                                            <img src="themeadmin/velzon/assets/images/users/avatar-10.jpg"
                                                alt=""
                                    ...
                                    <li class="list-group-item list-group-item-action">
                                        <div class="d-flex align-items-center">
                                            <img src="themeadmin/velzon/assets/images/nft/img-01.jpg"
                                                alt=""
                                                class="avatar-xs object-fit-cover rounded-circle">
                                            <div class="ms-3 flex-grow-1">
                                                <a href="#!">
                                    ...
                                    <li class="list-group-item list-group-item-action">
                                        <div class="d-flex align-items-center">
                                            <img src="themeadmin/velzon/assets/images/nft/img-04.jpg"
                                                alt=""
                                                class="avatar-xs object-fit-cover rounded-circle">
                                            <div class="ms-3 flex-grow-1">
                                                <a href="#!">
                                    ...
                                    <li class="list-group-item list-group-item-action">
                                        <div class="d-flex align-items-center">
                                            <img src="themeadmin/velzon/assets/images/nft/img-06.jpg"
                                                alt=""
                                                class="avatar-xs object-fit-cover rounded-circle">
                                            <div class="ms-3 flex-grow-1">
                                                <a href="#!">
                                    ...
                                    <li class="list-group-item list-group-item-action">
                                        <div class="d-flex align-items-center">
                                            <img src="themeadmin/velzon/assets/images/users/avatar-8.jpg"
                                                alt=""
                                                class="avatar-xs object-fit-cover rounded-circle">
                                            <div class="ms-3 flex-grow-1">
                                                <a href="#!">
                                    ...
                                    <li class="list-group-item list-group-item-action">
                                        <div class="d-flex align-items-center">
                                            <img src="themeadmin/velzon/assets/images/nft/img-03.jpg"
                                                alt=""
                                                class="avatar-xs object-fit-cover rounded-circle">
                                            <div class="ms-3 flex-grow-1">
                                                <a href="#!">
                                    ...
                                    <li class="list-group-item list-group-item-action">
                                        <div class="d-flex align-items-center">
                                            <img src="themeadmin/velzon/assets/images/nft/img-05.jpg"
                                                alt=""
                                                class="avatar-xs object-fit-cover rounded-circle">
                                            <div class="ms-3 flex-grow-1">
                                                <a href="#!">
                ...
                <div class="swiper marketplace-swiper rounded gallery-light">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="card explore-box card-animate rounded">
                                <div class="explore-place-bid-img">
                                    <img src="../../../../img.themesbrand.com/velzon/images/img-3.gif"
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details.html"
                                            class="text-body">Walking On Air</a></h5>
                                    <p class="text-muted mb-0">Artwork</p>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="card explore-box card-animate rounded">
                                <div class="explore-place-bid-img">
                                    <img src="themeadmin/velzon/assets/images/nft/img-03.jpg" alt=""
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details.html"
                                            class="text-body">Filtered Portrait</a></h5>
                        ...
                        <div class="swiper-slide">
                            <div class="card explore-box card-animate rounded">
                                <div class="explore-place-bid-img">
                                    <img src="../../../../img.themesbrand.com/velzon/images/img-1.gif"
                                        alt="" class="img-fluid card-img-top explore-img" />
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-secondary"><i
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details.html"
                                            class="text-body">Patterns Arts & Culture</a></h5>
                                    <p class="text-muted mb-0">Artwork</p>
                                </div>
                                <div class="card-footer border-top border-top-dashed">
                                    <div class="d-flex align-items-center">
                        ...
                        <div class="swiper-slide">
                            <div class="card explore-box card-animate rounded">
                                <div class="explore-place-bid-img">
                                    <img src="../../../../img.themesbrand.com/velzon/images/img-4.gif"
                                        alt="" class="img-fluid card-img-top explore-img" />
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-secondary"><i
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details.html"
                                            class="text-body">Evolved Reality</a></h5>
                                ...
                                <table class="table table-borderless align-middle">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="themeadmin/velzon/assets/images/nft/img-02.jpg"
                                                        alt="" class="avatar-sm rounded-circle">
                                                    <div class="ms-3">
                                                        <a href="#!">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3">
                                                        <a href="#!">
                                                            <h6 class="mb-1">Cryptocurrency Price Bitcoin
                                                            </h6>
                                                        </a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="../../../../img.themesbrand.com/velzon/images/img-5.gif"
                                                        alt="" class="avatar-sm rounded-circle">
                                                    <div class="ms-3">
                                                        <a href="#!">
                            ...
                            <table
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-1"><a href="apps-nft-item-details.html"
                                                            class="text-body">Abstract Face Painting</a></h6>
                                                    <p class="text-muted fs-13 mb-0"> Artworks</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td><img src="themeadmin/velzon/assets/images/svg/crypto-icons/btc.svg"
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="themeadmin/velzon/assets/images/svg/crypto-icons/ltc.svg"
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="themeadmin/velzon/assets/images/svg/crypto-icons/etc.svg"
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="themeadmin/velzon/assets/images/svg/crypto-icons/dash.svg"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-1"><a href="apps-nft-item-details.html"
                                                            class="text-body">Creative Filtered Portrait</a>
                                                    </h6>
                                        ...
                                        <td><img src="themeadmin/velzon/assets/images/svg/crypto-icons/bnb.svg"
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="themeadmin/velzon/assets/images/svg/crypto-icons/usdt.svg"
            ...
            <div class="col-xxl-3 col-lg-6">
                <div class="card card-height-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-1">
                            <p class="mb-1"><img src="themeadmin/velzon/assets/images/flags/us.svg"
                                    alt="" height="15" class="rounded me-2"> United States
                                <span class="float-end">34%</span></p>
                            <p class="mb-1"><img src="themeadmin/velzon/assets/images/flags/russia.svg"
                                    alt="" height="15" class="rounded me-2"> Russia <span
                                    class="float-end">27%</span></p>
                            <p class="mb-1"><img src="themeadmin/velzon/assets/images/flags/spain.svg"
                                    alt="" height="15" class="rounded me-2"> Spain <span
                                    class="float-end">21%</span></p>
                            <p class="mb-1"><img src="themeadmin/velzon/assets/images/flags/italy.svg"
                                    alt="" height="15" class="rounded me-2"> Italy <span
                                    class="float-end">13%</span></p>
                            <p class="mb-0"><img src="themeadmin/velzon/assets/images/flags/germany.svg"
                        ...
                        <div class="swiper collection-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="d-flex">
                                        <div class="flex-shink-0">
                                            <img src="themeadmin/velzon/assets/images/nft/img-02.jpg"
                                                alt="" class="avatar-sm object-fit-cover rounded">
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                                            ...
                                            <p class="text-muted mb-0"><i
                                                    class="mdi mdi-ethereum text-primary fs-14"></i> 81,369
                                                ETH</p>
                                        </div>
                                        <div>
                                ...
                                <div class="swiper-slide">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-3 flex-grow-1">
                                            ...
                                            <p class="text-muted mb-0"><i
                                                    class="mdi mdi-ethereum text-primary fs-14"></i> 68,945
                                                ETH</p>
                                        </div>
                                        <div>
                                            <div class="dropdown float-end">
                                ...
                                <div class="swiper-slide">
                                    <div class="d-flex">
                                        <div class="flex-shink-0">
                                            <img src="themeadmin/velzon/assets/images/users/avatar-1.jpg"
                                                alt="" class="avatar-sm object-fit-cover rounded">
                                        </div>
                                        <div class="ms-3 flex-grow-1">
                                            <a href="pages-profile.html">
                                            ...
                                            <p class="text-muted mb-0"><i
                                                    class="mdi mdi-ethereum text-primary fs-14"></i> 49,031
                                                ETH</p>
                                        </div>
                                        <div>
                                            <div class="dropdown float-end">
